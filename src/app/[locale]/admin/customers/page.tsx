    ...
    <div className="p-6">
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Sistemdə qeydiyyatdan keçmiş bütün müştərilər.</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-12 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-bold text-gray-900 mb-2">Müştərilər siyahısı tezliklə</h3>
